        ...
        public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
                return builder.routes()
                                ...
                                .route("ts-user-service-user-branches", r -> r.path("/api/v1/user-branches/**")
                                                .uri("lb://ts-user-service"))
                                .route("ts-user-service-user-photos", r -> r.path("/api/v1/user-photos/**")
                                                .uri("lb://ts-user-service"))
                                ...
                                .route("ts-patient-service-addresses", r -> r.path("/api/v1/patient-addresses/**")
                                                .uri("lb://ts-patient-service"))
                                .route("ts-patient-service-emergency-contacts",
                                                r -> r.path("/api/v1/patient-emergency-contacts/**")
                                                                .uri("lb://ts-patient-service"))
                                .route("ts-patient-service-medical-history",
                                                r -> r.path("/api/v1/patient-medical-history/**")
                                                                .uri("lb://ts-patient-service"))
                                ...
                                .route("ts-patient-service-appointments", r -> r.path("/api/v1/patient-appointments/**")
                                                .uri("lb://ts-patient-service"))
                                .route("ts-patient-service-health-summary",
                                                r -> r.path("/api/v1/patient-health-summary/**")
                                                                .uri("lb://ts-patient-service"))
                                .route("ts-patient-service-advanced-search",
                                                r -> r.path("/api/v1/patient-advanced-search/**")
                                                                .uri("lb://ts-patient-service"))
                                ...
                                .route("ts-schedule-service-schedules", r -> r.path("/api/v1/schedules/**")
                                                .uri("lb://ts-schedule-service"))
                                .route("ts-schedule-service-appointments", r -> r.path("/api/v1/appointments/**")
                                                .uri("lb://ts-schedule-service"))
                                ...
                                .route("ts-payment-service-payments", r -> r.path("/api/v1/payments/**")
                                                .uri("lb://ts-payment-service"))
                                .route("ts-payment-service-transactions", r -> r.path("/api/v1/transactions/**")
                                                .uri("lb://ts-payment-service"))
                                ...
                                .route("ts-notification-service", r -> r.path("/api/notifications/**")
                                                .uri("lb://ts-notification-service"))
                                .route("ts-notification-service-templates",
                                                r -> r.path("/api/notifications/templates/**")
                                                                .uri("lb://ts-notification-service"))
